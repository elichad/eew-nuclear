...
def select_event(energy, material_properties): #classifies interaction dependent on energy and prob
    if energy > 1000000:
        ...
        random_number = random.randint(1, material_properties["total"])
        if random_number < material_properties["fission"]: 
            return 1
        elif random_number < material_properties["fission"] + material_properties["elastic"] and random_number > material_properties["fission"]: 
            return 2
        else: 
            return 3
